    ...
    <div class="invoice-layout">
      ...
      <v-app-bar app color="white" elevation="1" height="64">
        ...
        <div class="ml-4">
          ...
          <div class="header-subtitle">Subir documentos de facturaciÃ³n</div>
        </div>
        <v-spacer></v-spacer>
      ...
      <v-main class="main-content">
        ...
        <v-container class="py-8" max-width="800">
          <!-- InformaciÃ³n del proveedor (solo lectura) -->
                ...
                <v-row>
                  ...
                  <v-col cols="12">
                    <v-textarea
                      ...
                      label="DescripciÃ³n de Servicios/Productos"
                      variant="outlined"
                      density="comfortable"
                      class="custom-input"
                      rows="3"
                      :rules="[v => !!v || 'DescripciÃ³n requerida']"
            ...
            <v-card class="form-card mb-6" elevation="2">
              ...
              <v-card-text class="pa-6">
                ...
                >
                  ...
                  <h3 class="upload-title">Arrastra archivos aquÃ­ o haz clic para seleccionar</h3>
                  <p class="upload-subtitle">PDF, JPG, PNG â€¢ MÃ¡ximo 10MB por archivo</p>
                </div>
